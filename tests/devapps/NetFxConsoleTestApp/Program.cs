   ...
   ""id_token"":
    {
     ...
     ""acr"": {""values"": [""urn:mace:incommon:iap:silver""] }
        ...
        private static readonly IEnumerable<string> s_scopes = 
            //null;
            //new[] { "https://analysis.windows.net/powerbi/api/user_impersonation" };
            new[] { "User.Read" };
        ...
        private static readonly string[] s_overrideDefaultScopes = new[] { 
            "offline_access"
            , "openid"
            //,"profile"
            };
...
#pragma warning restore UseAsyncSuffix // Use Async suffix
        ...
        private static IPublicClientApplication CreatePca()
        {
            var builder = PublicClientApplicationBuilder
                            ...
                            .WithOverrideDefaultScopes(s_overrideDefaultScopes)
#if NET47
                    .WithDesktopFeatures()
#endif
